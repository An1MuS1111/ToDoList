...
// // Add a new todo
// router.post('/add', async (req, res) => {
//     const { userId, title, description, subTask, taskStartedAt, taskEndedAt, taskStatus, taskCategory } = req.body;
//     if (!userId || !title || !taskStartedAt || !taskEndedAt || !taskStatus || !taskCategory) {
//         return res.status(400).json({ error: 'Required fields are missing' });
//     }
...
// router.put('/:taskId', async (req, res) => {
//     const { taskId } = req.params;
//     const { title, description, subTask, taskStartedAt, taskEndedAt, taskCompletedAt, taskStatus, taskCategory } = req.body;
//     if (!title || !taskStartedAt || !taskEndedAt || !taskStatus || !taskCategory) {
//         return res.status(400).json({ error: 'Required fields are missing' });
//     }
